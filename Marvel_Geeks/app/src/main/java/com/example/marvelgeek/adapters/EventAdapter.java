...
public class EventAdapter extends BaseAdapter {
    ...
    private final Events mEvent;

    public EventAdapter(Context mContext, Events mEvent, HashMap<String, Integer> availableExtras) {
    ...
    private String getAvailableData(String string){
        ...
        switch (string) {
            case "Characters":
                returnString = String.valueOf(mEvent.getAvailableCharacter());
                break;
            case "Creators":
                returnString = String.valueOf(mEvent.getAvailableCreators());
                break;
            case "Stories":
                returnString = String.valueOf(mEvent.getAvailableStories());
                break;
            case "Comics":
                returnString = String.valueOf(mEvent.getAvailableComic());
                break;
        }
        return returnString;
    }
