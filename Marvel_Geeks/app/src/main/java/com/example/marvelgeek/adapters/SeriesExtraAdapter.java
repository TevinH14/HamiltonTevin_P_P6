...
public class SeriesExtraAdapter extends BaseAdapter {
    ...
    public SeriesExtraAdapter(Context mContext, Series mSeries,
    ...
    private String getAvailableData(String string){
        ...
        switch (string) {
            case "Characters":
                returnString = String.valueOf(mSeries.getAvailableCharacter());
                break;
            case "Creators":
                returnString = String.valueOf(mSeries.getAvailableCreators());
                break;
            case "Stories":
                returnString = String.valueOf(mSeries.getAvailableStories());
                break;
            case "Comics":
                returnString = String.valueOf(mSeries.getAvailableComic());
                break;
        }
        return returnString;
    }
