...
public class ComicExtraAdapter extends BaseAdapter {
    ...
    public ComicExtraAdapter(Context mContext, Comics mComics ,
    ...
    private String getAvailableData(String string){
        ...
        switch (string) {
            case "Characters":
                returnString = String.valueOf(mComics.getAvailableCharacters());
                break;
            case "Creators":
                returnString = String.valueOf(mComics.getAvailableCreators());
                break;
            case "Stories":
                returnString = String.valueOf(mComics.getAvailableStories());
                break;
            case "Events":
                returnString = String.valueOf(mComics.getAvailableEvents());
                break;
        }
        return returnString;
    }
